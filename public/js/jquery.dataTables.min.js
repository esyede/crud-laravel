...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": aktifkan untuk urutan naik",sSortDescending:": aktifkan untuk urutan turun"},oPaginate:{sFirst:"Awal",sLast:"Akhir",sNext:"Lanjut",sPrevious:"Balik"},sEmptyTable:"Tidak ada data yang tersedia.",sInfo:"Menampilkan _START_ s/d _END_ dari _TOTAL_ data",sInfoEmpty:"Menampilkan 0 s/d 0 dari 0 data",sInfoFiltered:"(disaring dari _MAX_ total data)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Tampil _MENU_ data",sLoadingRecords:"Memuat...",sProcessing:"Memproses...",sSearch:"Cari: ",sSearchPlaceholder:"Ketik disini..",sUrl:"",sZeroRecords:"Tidak ada data yang cocok"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
