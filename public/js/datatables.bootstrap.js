 ...
 * Copyrirgt 2011-2014 SpryMedia Ltd - datatables.net/license
 */
    ...
    var factory = function ($, DataTable) {
        ...
        if ( DataTable.TableTools ) {
            ...
            $.extend( true, DataTable.TableTools.classes, {
                ...
                "buttons": {
                    "normal": "btn btn-default btn-flat btn-responsive",
                    "disabled": "disabled"
                },
                "collection": {
    ...
    "bootstrap": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                ...
                '<li class="first disabled"><a href="#" title="' + oLang.sFirst 
                    + '"><span class="glyphicon glyphicon-fast-backward"></span></a></li>' +
                '<li class="prev disabled"><a href="#" title="' + oLang.sPrevious 
                    + '"><span class="glyphicon glyphicon-step-backward"></span></a></li>' +
                '<li class="next disabled"><a href="#" title="' + oLang.sNext 
                    + '"><span class="glyphicon glyphicon-step-forward"></span></a></li>' +
                '<li class="last disabled"><a href="#" title="' + oLang.sLast 
